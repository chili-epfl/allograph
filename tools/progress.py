...
if __name__ == "__main__":
    ...
    with open('2sess.csv', 'wb') as csvfile:
                    ...
                    if found_repetition:
                        ...
                        for liste in lines:
                            ...
                            if letter in current_demo and letter in current_learn:
                                ...
                                wr.writerow([liste[0],liste[1],liste[2],liste[3],float('nan'),float('nan'),1,f2f])
#                       lines = []
#                       current_demo = {}
#                       current_learn = {}
#                       feedback = float('nan')
                    ...
                    if found_word:
                        ...
                        if word_done:
                            for liste in lines:
                                ...
                                if letter in current_demo and letter in current_learn:
                                    _,score = stroke.euclidian_distance(current_demo[letter], current_learn[letter])
                                    wr.writerow([liste[0],liste[1],liste[2],liste[3],score,feedback/nb_fb,1,f2f])
                            lines = []
                            current_demo = {}
                            current_learn = {}
                            feedback = float('nan')
                ...
                for line in log.readlines():
                    ...
                    if found_repetition:
                        ...
                        for liste in lines:
                            ...
                            if letter in current_demo and letter in current_learn:
                                _,score = stroke.euclidian_distance(current_demo[letter], current_learn[letter])
                                wr.writerow([liste[0],liste[1],liste[2],liste[3],float('nan'),float('nan'),2,f2f])
#                       lines = []
#                       current_demo = {}
#                       current_learn = {}
#                       feedback = float('nan')
                    ...
                    if found_word:
                        ...
                        if word_done:
                            for liste in lines:
                                ...
                                if letter in current_demo and letter in current_learn:
                                    _,score = stroke.euclidian_distance(current_demo[letter], current_learn[letter])
                                    wr.writerow([liste[0],liste[1],liste[2],liste[3],score,feedback/nb_fb,2,f2f])
                            lines = []
                            current_demo = {}
                            current_learn = {}
                            feedback = float('nan')
